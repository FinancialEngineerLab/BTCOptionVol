...
btc_call = df[df.option_type == 'C']
btc_subset = btc_call[btc_call.timestamp == date].sort_values('index_price')
btc_subset[['timestamp','index_price', 'mid_iv']].head()
